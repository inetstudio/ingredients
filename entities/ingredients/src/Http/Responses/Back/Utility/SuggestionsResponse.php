...
namespace InetStudio\IngredientsPackage\Ingredients\Http\Responses\Back\Utility;
...
class SuggestionsResponse implements SuggestionsResponseContract
{
    ...
    public function toResponse($request)
    {
        $transformer = app()->make(
            'InetStudio\IngredientsPackage\Ingredients\Contracts\Transformers\Back\Utility\SuggestionTransformerContract',
            [
                'type' => $this->type,
            ]
        );
